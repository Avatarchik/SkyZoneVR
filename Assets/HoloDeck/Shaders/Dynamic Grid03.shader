...
////// Emissive:
                ...
                float4 node_4039 = _Time + _TimeEditor;
                float2 node_2139 = (i.uv0+node_4039.g*float2(0,0.1));
                float4 _EmissiveUp_var = tex2D(_EmissiveUp,TRANSFORM_TEX(node_2139, _EmissiveUp));
                float2 node_9265 = (i.uv0+node_4039.g*float2(0.1,0));
